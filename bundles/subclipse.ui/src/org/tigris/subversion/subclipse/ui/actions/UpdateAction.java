...
/**
 * UpdateAction performs a 'svn update' command on the selected resources. If conflicts are present
 * (file has been changed both remotely and locally), the changes will be merged into the local file
 * such that the user must resolve the conflicts.
 */
